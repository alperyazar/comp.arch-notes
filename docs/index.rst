...
your comments and corrections. If you have anything to say, you can
:ref:`contact_page`.
Moreover, it would be great if you contribute by
creating new pages or fixing errors. Just check :ref:`contributing_page` page.

Lastly, I would like to kindly remind that all materials (including text) are
licensed and copyrighted. License is **CC-BY-SA-4.0** if otherwise stated.
You are free to share and adapt materials even for commercial purposes if you
follow license conditions. Just check :ref:`license_page`
and :ref:`copyright_page` page.
As stated in Section 5 of
CC-BY-SA-4.0 legal code, all materials (independent from chosen license)
are provided **AS-IS** and **NO
WARRANTY**. Check :ref:`disclaimer_page` page if you need.
